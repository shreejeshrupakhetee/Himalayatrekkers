                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            {{-- <div class="form-group">
                                <label class="control-label">Add Review of ?</label> <br>
                                <label> Region </label>
                                <input type="radio" name="alOf"  value="r" class="album" @if(isset($dataTypeContent->id) && $dataTypeContent->region_id != 0) checked @endif>
                                <label> Trip </label>
                                <input type="radio" name="alOf" value="t" class="album" @if(isset($dataTypeContent->id) && $dataTypeContent->trip_id != 0) checked @endif>
                            </div> --}}
                      <!-- end added -->
