                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <textarea class="form-control editor" name="body">{{ $dataTypeContent->body ?? '' }}</textarea>
                        </div>
                    </div><!-- .panel -->
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @php
                                $dataTypeRows = $dataType->{($edit ? 'editRows' : 'addRows' )};
                                $exclude = ['title', 'body', 'excerpt', 'slug', 'status', 'body', 'image', 'metadisc', 'metakey', 'metatitle'];
                            @endphp
