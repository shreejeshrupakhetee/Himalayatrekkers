...
<section class="lg:hidden top-nav bg-black px-4 md:px-6 xl:px-8"> {{-- sano screen --}}
    <div class="container mx-auto">
        <div class="flex justify-between py-2">
            <div class="social phone cta flex items-center text-white">
                <p>
            ...
            <div class="lg:flex lg:justify-between lg:items-center">
                <a aria-label="Home Page" href="/">
                    <amp-img v-pre alt="Himalayan Trekkers Logo" title="Himalayan Trekkers"
                        src="/images/logo_new.svg" width="160" height="64" class="hidden lg:block">
                    </amp-img>
                </a>
                <nav class="main-menu" id="main-menu">
                    ...
                    <label for="mobile" id="mobile-menu">
                        <a href="/" target="_top" title="Himalayan Trekkers Logo" class="inline-block">
                            <amp-img v-pre alt="Himalayan Trekkers Logo" title="Himalayan Trekkers Logo"
                                src="/images/logo_new.svg" width="140" height="50" class="">
                            </amp-img>
                        </a>
                        <div class="ml-auto inline-block lg:hidden mr-12 float-right mt-3">
                            <button aria-label="Search" onclick="open_modal()"
                                class="inline-block p-2 rounded-xl shadow-none bg-regal-blue hover:text-black hover:bg-hover-yellow text-white btns">
                                <svg class="h-4 font-semibold" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        ...
                        </div> <span aria-label="Menu" class="main-menu-dropdown-icon">
                            {{-- <i class="hamburger bg-black"></i> --}}
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 hamburger" fill="none"
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="main-menu-dropdown">
                            ...
                            </a> <label class="hidden lg:block main-menu-dropdown-icon"
                                for="main-menu-dropdown-list-2">
                                <i class="arrow-down arrow-down-mobile"></i>
                            </label>
                        ...
                        <li class="main-menu-dropdown">
                            <a href="/multicountry-tours-and-treks">
                                {{-- <i class="fa fa-list-ul m-none"></i> --}}
                                MultiCountry
                                <span class="main-menu-dropdown-icon">
                                    <i class="arrow-down"></i>
                                </span>
                            ...
                            <ul class="main-menu-dropdown-list">
                                <li>
                                    <a href="/nepal-bhutan-tours">Nepal Bhutan Tours
                                        {{-- <span class="main-menu-dropdown-icon">
                    ...
                    </li> <!-- Multiple level main-menu-dropdown -->
                    <li class="main-menu-dropdown">
                        <a href="#">
                            More
                            <span class="main-menu-dropdown-icon">
                ...
                <div class="hidden lg:block">
                    <button onclick="open_modal()"
                        class="inline-block h-8 w-8 p-2 rounded-xl shadow-none bg-regal-blue hover:text-black hover:bg-hover-yellow text-white btns">
                        <svg class="h-4 font-semibold" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
...
<div id="id01" class="w3-modal shadow-inner">
    <div class="w3-modal-content bg-white p-0 relative rounded-xl">
        <header class="container mx-auto">
            <span onclick="document.getElementById('id01').style.display='none'"
                class="w3-button flex justify-end"></span>
        </header>
        <div class="container mx-auto">
            <newsearch></newsearch>
        </div>
