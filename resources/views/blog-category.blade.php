...
@section('metatags')
    ...
    <meta name="description"
        content="Love Traveling ? Himalayan Trekkers provides you various topics and throws some insights on whats trending currently in our blogs section.">
    <title>{{ $category->name }} Blogs and News | Himalayan Trekkers</title>
            ...
            <div class="container mx-auto">
                <div class="md:grid md:grid-cols-10 md:gap-5">
                    ...
                    @php
                        ...
                        $blogs = $category->posts()->paginate(10);
                    @endphp
