...
@section('metatags')
<meta name="title" content="Countries | Himalayan Trekkers">
<meta name="keywords" content="nepal, bhutan, tibet, india, multicountry tour">
<meta name="description" content="Himalayan Trekkers - Plan Your dream adventure tour and trek to Nepal, Bhutan, Tibet, India, or multicountry tour. Customize the existing itinerary the way you want.">
<title>Himalayan Countries | Himalayan Trekkers</title>
<style>
    #pageDestinations {
    width: 100%;
}
...
<div id="app">
    <div class="container mx-auto">
        <main id="pageDestinations" class="pb-10 md:pb-20">
                    ...
                    <li>
                        <a href="/{{ $c->slug }}">
                            <div class="img__holder">
                                <img src="{{Voyager::image($c->thumbnail('cropped'))}}" alt="{{ $c->title }}" />
                            </div>
                            <div class="d_hold">
                                <h2>{{ $c->title }}</h2>

                                <p>{!! Str::limit($c->content,180) !!}</p>
